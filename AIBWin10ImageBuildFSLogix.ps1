...
#Install VSCode
Invoke-WebRequest -Uri 'https://az764295.vo.msecnd.net/stable/f30a9b73e8ffc278e71575118b6bf568f04587c8/VSCodeUserSetup-x64-1.54.1.exe' -OutFile 'c:\temp\VScode.exe'
